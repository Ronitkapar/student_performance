...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'x86_64-apple-darwin13.4.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/home/ronit/stu_perform/venv/lib '
 ...
 'CFLAGS': '-fno-strict-aliasing -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-fdebug-prefix-map=/home/ronit/stu_perform/venv=/usr/local/src/conda-prefix '
 ...
 'CONFIGURE_LDFLAGS': '-Wl,-pie -Wl,-headerpad_max_install_names '
                      ...
                      '-L/home/ronit/stu_perform/venv/lib '
                      '-flto -Wl,-export_dynamic',
 'CONFIG_ARGS': "'--prefix=/home/ronit/stu_perform/venv' "
 ...
 'LIBFFI_INCLUDEDIR': '/home/ronit/stu_perform/venv/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/home/ronit/stu_perform/venv/lib/pkgconfig',
 'LIBPL': '/home/ronit/stu_perform/venv/lib/python3.8/config-3.8-darwin',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/home/ronit/stu_perform/venv/include',
 'OPENSSL_LDFLAGS': '-L/home/ronit/stu_perform/venv/lib',
